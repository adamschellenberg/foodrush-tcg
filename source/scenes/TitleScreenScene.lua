...
TitleScreenScene = {}
class("TitleScreenScene").extends(NobleScene)
local scene = TitleScreenScene
...
function scene:init()
	...
	background = Graphics.image.new("assets/images/background-title")
...
scene.inputHandler = {
	...
	AButtonDown = function()			-- Runs once when button is pressed.
		-- Your code here
		Noble.transition(ExampleScene, 1, Noble.TransitionType.DIP_TO_BLACK)
	end,
